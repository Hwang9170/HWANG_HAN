document.addEventListener('DOMContentLoaded', () => {
    ...
    const yeonnamCafes = {
        date: ['본지르르 연희', '봄봄', '미각', '고서커피', '청수당 공명', '라헬의부엌', '가즈', 'KOG', '테일러커피', '베란다컵케익', '드댕', '리브레', '브라운하우스', '레인리포트', '스타', '마가렛연남', '베니케이크', '카페레이어드', '기억안남', '카페 공명', '터틀힙', '코리코카페', '폴바셋', '티크닉', '오이', '코이크', '일쩜오플로어', '애몽', '연남동그라미', '클로이인패리스', '피크닉', '발트', '카페드댕', '랜디스 도넛', '카페 레이어드', '달콤다정', '라온디', '봄', '작당모의', '에브리데이해피벌스데이', '블루보틀', '레인리포트 브리티시', '바이닐하우스', '땡스오트'],
        relax: ['본지르르 연희', '봄봄', '미각', '고서커피', '청수당 공명', '라헬의부엌', '가즈', 'KOG', '테일러커피', '베란다컵케익', '드댕', '리브레', '브라운하우스', '레인리포트', '스타', '마가렛연남', '베니케이크', '카페레이어드', '기억안남', '카페 공명', '터틀힙', '코리코카페', '폴바셋', '티크닉', '오이', '코이크', '일쩜오플로어', '애몽', '연남동그라미', '클로이인패리스', '피크닉', '발트', '카페드댕', '랜디스 도넛', '카페 레이어드', '달콤다정', '라온디', '봄', '작당모의', '에브리데이해피벌스데이', '블루보틀', '레인리포트 브리티시', '바이닐하우스', '땡스오트'],
        study: ['땡스오트', '테일러커피']
    };
